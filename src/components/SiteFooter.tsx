              ...
              <div className={styles.contactInfoList}>
                <div className={styles.contactItem}>
                  ...
                  <div>
                    ...
                    <span>Thanisandra Main Rd, Sri Balaji Krupa Layout, RK Hegde Nagar, Bengaluru, Karnataka 560064</span>
                  </div>
                </div>
                ...
                <div className={styles.contactItem}>
                  ...
                  <div>
                    <a
                      href="https://www.instagram.com/construction_buddy1/"
                      target="_blank"
                ...
                <div className={styles.contactItem}>
                  ...
                  <div>
                    <a
                      href="https://youtube.com/@constructionbuddy-b3z?si=2NnKpjzK8PXsVmzP"
                      target="_blank"
                      rel="noopener noreferrer"
                      className={styles.contactLink}
                    >
                      @constructionbuddy-b3z
                    </a>
                    <span style={{ display: 'block', fontSize: '0.78rem', color: '#7e91aa' }}>
                      Watch on YouTube
                    </span>
