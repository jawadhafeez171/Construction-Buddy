  ...
  return (
    <>
      ...
      <div className="mobile-bottom-nav">
        ...
        <a href="/refer" className="mobile-bottom-nav-item" style={{ color: 'var(--primary)' }}>
          <svg viewBox="0 0 24 24" width="20" height="20" stroke="currentColor" strokeWidth="2.5" fill="none" strokeLinecap="round" strokeLinejoin="round" className="mobile-bottom-nav-icon">
          ...
          <span className="mobile-bottom-nav-label">Refer</span>
        </a>
        <a href="/blog" className="mobile-bottom-nav-item">
